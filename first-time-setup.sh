...
lowercase_jurisdiction_name=$(echo $JURISDICTION_NAME | tr '[:upper:]' '[:lower:]')  # accent transliteration removed: BSD sed on macOS rejects the multibyte y/// expression; not needed for ASCII names
